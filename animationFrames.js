...
const CROUCHING_FRAMES = [
    {
        ...
        balls: { x: 0.5, y: 0.3 },
        leftKnee: { x: 0.35, y: 0.1 },
        rightKnee: { x: 0.83, y: 0.18},
        leftFoot: { x: 0, y: 0 },
        rightFoot: { x: 0.7, y: 0 },
    },
    {
        head: { x: 0.8, y: 0.67 },
        kneck: { x: 0.7, y: 0.52 },
        leftElbow: { x: 0.20, y: 0.37 },
        rightElbow: { x: 0.95, y: 0.27 },
        leftHand: { x: 0.23, y: 0.22 },
        rightHand: { x: 1.25, y: 0.24 },
        balls: { x: 0.5, y: 0.27 },
        leftKnee: { x: 0.36, y: 0.08 },
        rightKnee: { x: 0.85, y: 0.16 },
        leftFoot: { x: 0, y: 0 },
        rightFoot: { x: 0.7, y: 0 },
    },
];